...
Section Server s1
  ...
  ${AndIf} $3 != 0
    ...
    File "mysql-installer-web-community-5.6.27.0.msi"
    ExecWait 'msiexec /i mysql-installer-web-community-5.6.27.0.msi /qn'
;      5.6             http://dev.mysql.com/downloads/file/?id=459309
; -----5.7-----------------------------------------------------     http://dev.mysql.com/downloads/file/?id=459895
    ExecWait '"$PROGRAMFILES\MySql\MySQL Installer for Windows\MySQLInstallerConsole.exe" community install server;5.6.27;x64:*:port=3306;passwd=password -silent'
